...
const Navbar = () => {
  ...
  return (
    <div
      ...
      className={
        shadow
          ? 'fixed w-full h-20 bg-rose-500 shadow-xl z-[100] ease-in-out duration-300'
          : 'fixed w-full h-20 z-[100] bg-gradient-to-r from-white to-rose-200'
      }
    >
      ...
      >
        ...
        <div
          className={
            nav
              ? ' fixed left-0 top-0 w-[75%] sm:w-[60%] md:w-[45%] h-screen bg-gradient-to-r from-rose-200 to-white p-10 ease-in duration-500'
